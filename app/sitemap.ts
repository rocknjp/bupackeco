...
const staticRoutes: { path: string; lastmod: string; changefreq: "weekly" | "monthly"; priority: number }[] = [
  ...
  { path: "/products", lastmod: "2026-07-07", changefreq: "weekly", priority: 0.8 },
  { path: "/products/custom-mailer-boxes", lastmod: "2026-07-07", changefreq: "monthly", priority: 0.9 },
  { path: "/products/rigid-gift-boxes", lastmod: "2026-07-07", changefreq: "monthly", priority: 0.9 },
  { path: "/products/folding-cartons", lastmod: "2026-07-07", changefreq: "monthly", priority: 0.9 },
  { path: "/products/custom-paper-bags", lastmod: "2026-07-07", changefreq: "monthly", priority: 0.9 },
  ...
  { path: "/blog/custom-packaging-cost-optimization-strategies", lastmod: "2026-06-26", changefreq: "monthly", priority: 0.8 },
