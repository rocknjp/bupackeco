          ...
          <div className="prose prose-lg prose-green max-w-none">
            ...
            <div className="overflow-x-auto mb-6">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  <tr className="border-b border-gray-100"><td className="py-2 px-4 text-gray-700"><a href="/industries/beauty-skincare" className="text-green-700 underline">Beauty & Skincare</a></td><td className="py-2 px-4 text-gray-700">FSC-coated + soft-touch lamination</td><td className="py-2 px-4 text-gray-700">Premium feel required; FSC adds credibility</td></tr>
                  <tr className="border-b border-gray-100"><td className="py-2 px-4 text-gray-700"><a href="/industries/corporate-gifts-subscription" className="text-green-700 underline">Gifts & Food</a></td><td className="py-2 px-4 text-gray-700">EN 13432 compostable + food-safe liner</td><td className="py-2 px-4 text-gray-700">Regulatory compliance for food contact</td></tr>
                  <tr className="border-b border-gray-100"><td className="py-2 px-4 text-gray-700"><a href="/industries/fragrance-candles" className="text-green-700 underline">Candles & Fragrance</a></td><td className="py-2 px-4 text-gray-700">FSC kraft with soy ink</td><td className="py-2 px-4 text-gray-700">Eco positioning aligns with brand values</td></tr>
                  <tr className="border-b border-gray-100"><td className="py-2 px-4 text-gray-700"><a href="/industries/jewelry-accessories" className="text-green-700 underline">Jewelry</a></td><td className="py-2 px-4 text-gray-700">FSC rigid box with recycled greyboard</td><td className="py-2 px-4 text-gray-700">Luxury + sustainability together</td></tr>
                  <tr className="border-b border-gray-100"><td className="py-2 px-4 text-gray-700"><a href="/industries/stationery-toys" className="text-green-700 underline">Apparel & Fashion</a></td><td className="py-2 px-4 text-gray-700">Kraft mailer box + paper tape</td><td className="py-2 px-4 text-gray-700">Replace poly mailers entirely</td></tr>
                  <tr className="border-b border-gray-100"><td className="py-2 px-4 text-gray-700"><a href="/industries/corporate-gifts-subscription" className="text-green-700 underline">Tea & Beverages</a></td><td className="py-2 px-4 text-gray-700">FSC kraft + compostable inner pouch</td><td className="py-2 px-4 text-gray-700">Moisture barrier + biodegradability</td></tr>
                </tbody>
              </table>
            </div>
