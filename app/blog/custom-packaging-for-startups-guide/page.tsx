          ...
          <div className="prose prose-lg prose-green max-w-none">
            ...
            <div className="overflow-x-auto mb-6">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  <tr className="border-b border-gray-100"><td className="py-2 px-4 text-gray-700">Skincare & beauty</td><td className="py-2 px-4 text-gray-700">Rigid setup box or folding carton</td><td className="py-2 px-4 text-gray-700">Premium feel, fits <a href="/industries/cosmetics-beauty" className="text-green-700 underline">beauty brand expectations</a></td></tr>
                  <tr className="border-b border-gray-100"><td className="py-2 px-4 text-gray-700">Candles & fragrance</td><td className="py-2 px-4 text-gray-700">Mailer box with insert</td><td className="py-2 px-4 text-gray-700">Protection + unboxing, see <a href="/industries/candles-fragrance" className="text-green-700 underline">candle packaging</a></td></tr>
                  <tr className="border-b border-gray-100"><td className="py-2 px-4 text-gray-700">Jewelry & accessories</td><td className="py-2 px-4 text-gray-700">Rigid gift box</td><td className="py-2 px-4 text-gray-700">Luxury presentation, <a href="/industries/jewelry" className="text-green-700 underline">jewelry box standards</a></td></tr>
                  <tr className="border-b border-gray-100"><td className="py-2 px-4 text-gray-700">Apparel & fashion</td><td className="py-2 px-4 text-gray-700">Custom mailer box</td><td className="py-2 px-4 text-gray-700">Branded shipping + unboxing, <a href="/industries/apparel-fashion" className="text-green-700 underline">fashion packaging</a></td></tr>
                  <tr className="border-b border-gray-100"><td className="py-2 px-4 text-gray-700">Food & confectionery</td><td className="py-2 px-4 text-gray-700">Folding carton + food-safe liner</td><td className="py-2 px-4 text-gray-700">FDA compliance, <a href="/industries/chocolate-confectionery" className="text-green-700 underline">food packaging guide</a></td></tr>
