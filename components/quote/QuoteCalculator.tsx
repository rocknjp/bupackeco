    ...
    <div className="bg-white min-h-screen">
              ...
              <div className="p-6 relative">
                ...
                <div className="mt-3 rounded-lg bg-amber-50 border border-amber-200 p-3">
                  <p className="text-[11px] text-amber-900 leading-relaxed">
                    <strong>⚠️ Estimate only — not a quotation or offer.</strong>{" "}
                    Prices shown are approximate budget ranges for planning
                    purposes only and do not constitute a binding price,
                    quotation, or offer to sell. For an exact, official
                    quotation,{" "}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
          <h4 className="text-xs font-extrabold text-gray-600 uppercase tracking-wider mb-2.5">
            Important Disclaimer — Cost Estimation Tool
          </h4>
          <div className="text-xs text-gray-500 leading-relaxed space-y-2">
            <p>
              The prices generated by this calculator are{" "}
              <strong className="text-gray-700">
                approximate estimates provided solely as a cost-planning aid
              </strong>
              . They do not constitute a quotation, an offer, an acceptance of
              any order, or a commitment by BUpackEco / Qingdao Bejan Giant
              Packaging Co., Ltd. to sell at the displayed prices.
            </p>
            <p>
              Final pricing depends on structural design, artwork and print
              specifications, material availability, quality standards,
              order quantity, Incoterms, freight, and other project details.
              For a{" "}
              <strong className="text-gray-700">
                binding, official quotation
              </strong>
              , please{" "}
              <a href="/contact/" className="font-bold text-green-700 underline">
                contact our team
              </a>{" "}
